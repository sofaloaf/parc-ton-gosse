		...
		<div style={{
			...
			<div style={{
				...
				<h2 style={{
					...
					{locale === 'fr' 
						? 'Votre temps de navigation gratuit est écoulé'
						: 'Your free browsing time has expired'}
				</h2>
				...
				<p style={{
					...
					{locale === 'fr' 
						? 'Pour continuer à explorer toutes les activités et fonctionnalités de Parc Ton Gosse, veuillez vous engager à payer. Aucun paiement ne sera effectué aujourd\'hui - vous serez facturé au lancement de la plateforme (Q1 2025).'
						: 'To continue exploring all activities and features of Parc Ton Gosse, please commit to pay. No payment will be processed today - you will be charged when the platform launches (Q1 2025).'}
				</p>
